...
<html>
    ...
    <body>
        <%
            ...
            String query="select password from employer where username='"+uname+"';";
            Connection con=null;
		try
		{
		...
		catch(Exception e)
		{
                ...
                if(oldpass.equals(rs.getString(1))){
                    String query1="update employer set password='"+newpass+"' where username='"+uname+"';";
                    System.out.println(query1);
                    st.executeUpdate(query1);
                    out.println("Password Successfully Changed");
                    %><br><br><a href="../../../topjobs/info/employer.jsp">go back</a><%   
                }else{
                    out.println("Wrong Password!!! Try Again");
                    %><br><br><a href="emp.jsp">go back</a><%
                }       
            }
